...
(function () {
    ...
    if (!document.getElementById('review-write-styles')) {
        ...
        style.textContent = [
            ...
            '.tbb-comment-avatar { width: 36px; height: 36px; border-radius: 50%; background-color: #c62828; color: #fff; display: flex; align-items: center; justify-content: center; font-family: Buvera; font-weight: 700; font-size: 0.9rem; flex-shrink: 0; }',
            ...
            '.tbb-comment-name { font-family: Buvera; font-weight: 700; font-size: 0.85rem; color: #111; }',
            '.tbb-name-tbb { color: #c62828 !important; }',
            '.tbb-comment-date { font-family: Buvera; font-size: 0.75rem; color: #999; }',
            '.tbb-comment-body p { font-family: Buvera; font-size: 0.9rem; color: #333; line-height: 1.6; margin: 0 0 0.4rem; }',
            '.tbb-comment-reply-btn { background: none; border: none; cursor: pointer; font-size: 0.78rem; color: #999; font-family: Buvera; padding: 0; transition: color 0.2s; }',
            ...
            '.tbb-comment-form-heading { font-family: Buvera; font-size: 0.95rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; color: #111; margin: 0; }',
            '.tbb-comment-input { border: 1px solid #ddd; border-radius: 4px; padding: 8px 12px; font-size: 0.9rem; font-family: Buvera; outline: none; width: 100%; box-sizing: border-box; }',
            '.tbb-comment-textarea { border: 1px solid #ddd; border-radius: 4px; padding: 10px 12px; font-size: 0.9rem; font-family: Buvera; outline: none; width: 100%; min-height: 100px; resize: vertical; box-sizing: border-box; }',
            '.tbb-comment-input:focus, .tbb-comment-textarea:focus { border-color: #c62828; }',
            '.tbb-comment-submit { align-self: flex-start; background-color: #c62828; color: #fff; border: none; border-radius: 4px; padding: 9px 22px; font-size: 0.88rem; font-weight: 700; font-family: Buvera; cursor: pointer; transition: background-color 0.2s; }',
